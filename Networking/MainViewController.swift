...
enum Actions: String, CaseIterable {
    ...
    case ourCoursesAlamofire = "Our Courses (Alomofire)"
    ...
    case putRequest = "PUT with Alofire"
}
...
extension MainViewController {
    ...
    private func registredForNotification() {
    ...
    private func postNotification() {
        ...
        content.body = "Your backfraund transfer has completed. File path: \(filePath!)"
        
        let trigger = UNTimeIntervalNotificationTrigger(timeInterval: 3, repeats: false)
        
        let request = UNNotificationRequest(identifier: "TranferComlete", content: content, trigger: trigger)
